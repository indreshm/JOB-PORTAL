...
import amreshsir from './indresh.jpg'; // Import the local image
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center w-full">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-2">
              ...
              at University School of Information, Communication and
              Technology(GGSIPU). I'm passionate about technology and love
              exploring new things. I'm a passionate Java , MERN Stack developer
              with a keen interest in building innovative web applications. I'm
